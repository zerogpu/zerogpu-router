---
name: chat-liquid
description: Fastest, cheapest chat reply via Liquid AI's edge model (LFM2.5-1.2B-Instruct). Use when the user wants a quick, single-turn answer that does not need Claude-level reasoning, prior conversation context, or code generation, and explicitly favors speed or cost over quality.
argument-hint: "<text>"
